...
// DATABASE REQUESTS
const getStopByName = (stop_name, excludeChilds = true) => {
    var querry = { stop_name: { '$regex': stop_name, $options: 'i' } }
...
function styleOutput(data) {
    ...
    const filtered_data =  data.map(e=> _.pick(e, ['departure_time', 'trip.trip_headsign'])) 

    // Sort by departure time
    return _.sortBy(filtered_data, [function(o) { return o.departure_time; }]);
